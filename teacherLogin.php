<html lang="en"><head>
    ...
    <title>StudentFirst | Professor Login</title>
...
if($_POST){
  ...
  $userCheck = $connect->query("SELECT * FROM PROFESSORS WHERE EMAIL='$inputEmail'");
  if((mysqli_num_rows($userCheck) > 0)){
    $userCheckArr = mysqli_fetch_array($userCheck);
    echo $userCheckArr['PROFESSORID'];
...
function redirectToRegister(){
  location.href = "professorRegister.php";
}
</script>
...
<body class="text-center" style="background-color: #CDEDF6;">
  ...
  <div class="col align-items-start">
    ...
    <form class="form-signin" action="teacherLogin.php" method="post">
      <h1 class="h3 mb-3 font-weight-normal" style="color:white;">Professor Sign In</h1>
  ...
  <button class="btn btn-lg btn-primary" style="margin-top: 16px; width: 200px;"} onClick="redirectToStudent();">Student Login</button>
	</div>
	    <div class="col-sm-4">
