<html lang="en"><head>
    ...
    <title>StudentFirst | Student Register</title>
...
<?php
  if($_POST){
    ...
    $userClasses = "";
  	$userClassesQuery = $connect->query("INSERT INTO STUDENTS(STUDENTNAME,EMAIL,PASSWORD) VALUES ('$fullName','$inputEmail','$inputPassword')");
    $userCheck = $connect->query("SELECT * FROM STUDENTS WHERE STUDENTNAME='$fullName' AND EMAIL='$inputEmail' AND PASSWORD='$inputPassword'");
...
<body class="text-center" style="background-color: #CDEDF6;">
  ...
  <div class="col align-items-start">
    ...
    <form class="form-signin" action="register.php" method="post">
      <h1 class="h3 mb-3 font-weight-normal" style="color:white;">Student Register</h1>
