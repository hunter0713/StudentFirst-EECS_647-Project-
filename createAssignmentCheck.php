...
if($_GET){
  $assignName = filter_input(INPUT_GET, "name");
...
if($connect->connect_error)
  ...
  $getAllStudents = $connect->query("INSERT INTO ASSIGNMENTS(ASSIGNMENTNAME,CLASSID,DESCRIPTION,ASSIGNMENTQUESTIONS) VALUES ('$assignName','$classid','$desc','$questions')");
$connect->close();
?>
  ...
  <div class="col align-items-start">
    ...
    <div class="col-sm-4">
      ...
      function goBackToDash(){
        location.href = "professorDashboard.php?id=" + "<?php echo $profID?>"
      }
      </script>
